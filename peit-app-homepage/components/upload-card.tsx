...
export function UploadCard({
  ...
  if (selectedFile) {
    const isDrawnGeometry = geometrySource === 'draw'

    return (
      <div className="mx-auto max-w-2xl">
        <div className="relative rounded-2xl border-2 border-primary bg-primary/5 p-8 md:p-12 transition-all duration-200 shadow-sm overflow-hidden">
          {/* Geometry Preview Background */}
          {geojsonData && (
          ...
          <div className="relative z-10 flex flex-col items-center text-center">
            ...
            <div className="mb-4 flex items-center gap-2 rounded-lg bg-card/80 backdrop-blur-sm px-4 py-2 border border-border">
            ...
            {/* Edit Drawing button for drawn geometries */}
            {isDrawnGeometry && onEditGeometry && !disabled && (
              <Button
                variant="outline"
                size="sm"
